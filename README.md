...
<table>
  <tr>
    <td><img src="docs/images/rocket-chat-markdown-plus-demo.webp" alt="Демонстрация Rocket.Chat Markdown+" width="480"></td>
    <td><img src="docs/images/rocket-chat-markdown-plus-form.png" alt="Форма оформления сообщения" width="220"></td>
  </tr>
</table>
...
Скопируйте `chrome://extensions` в адресную строку и откройте **Tampermonkey → Сведения**. Включите **«Разрешить пользовательские скрипты»** (Allow User Scripts). Если Tampermonkey установлен через **«Загрузить распакованное»**, также включите **«Режим разработчика»** на странице расширений.

### Firefox

Дополнительные настройки обычно не нужны.

Если кнопки нет, проверьте, что Tampermonkey и `Rocket.Chat Markdown+` включены.
...
Скрипт работает локально: без аналитики и внешнего сервера.
